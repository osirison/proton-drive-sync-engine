...
use crate::index::{
    ...
    ScanOptions, SyncStatus, delete_delete_approval, index_totals, load_event_cursor,
    ...
    replace_unsyncable_items, scan_local_entities_observed, scan_local_entities_reusing_hashes,
