...
export const KNOWN_DEVIATIONS = [
  ...
  },
  {
    ...
    detail: "43.86 vs 45.61",
    issue: "#221",
    why: "`Activity` at the wide window's 13px against the narrow window's 12.5px",
  },
  {
    frame: "5a Checking",
    key: "div[1]/div/span[0]",
  ...
  },
  {
    ...
    detail: "63.59 vs 66.14",
    issue: "#221",
    why: "`Plan a sync` at the wide window's 13px against the narrow window's 12.5px",
  },
  {
    frame: "5a Checking",
    key: "div[1]/div/span[1]",
  ...
  },
  {
    ...
    detail: "48.19 vs 50.11",
    issue: "#221",
    why: "`Settings` at the wide window's 13px against the narrow window's 12.5px",
  },
  {
    frame: "5a Checking",
    key: "div[1]/div/span[2]",
  ...
  },
  {
    ...
    detail: "39.63 vs 41.2",
    issue: "#221",
    why: "`Details` at the wide window's 13px against the narrow window's 12.5px",
  },
  {
    frame: "5a Checking",
    key: "div[1]/div/span[3]",
