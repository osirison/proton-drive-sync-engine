...
pub mod wire {
    ...
    pub use proton_drive_sync_engine::ipc::{
        ApplyOutcome, ControlCommand, ControlRequest, ControlResponse, PLAN_PASS_KIND,
        PendingDeletion, PlanOutcome, ReviewedPlan, RunningConfigInfo, StatusHistoryEntry,
    };
